	...
	<body>
		...
		<div id="show-aluno" class="content scaffold-show" role="main">
			...
			<ol class="property-list aluno">
				...
				<g:if test="${alunoInstance?.disciplinas}">
				<li class="fieldcontain">
					<span id="disciplinas-label" class="property-label"><g:message code="aluno.disciplinas.label" default="Disciplinas" /></span>
					
						<g:each in="${alunoInstance.disciplinas}" var="d">
